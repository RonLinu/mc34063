...
(function() {
  ...
  var RIPPLE, areValidNumbers, areWithinLimits, calculate, calculateBtn, clear_results, format_results, getFieldsValues, inverter, isValidFloat, saveBtn, showAlert, show_results, step_down, step_up, str_to_float;
...
// Only clear any red background color in fields
  ...
  (function() {    // --------------------------------------
    var i, input, inputs, len, onInputChange, results1;
    ...
    for (i = 0, len = inputs.length; i < len; i++) {
      input = inputs[i];
      results1.push(input.addEventListener('input', onInputChange));
    }
    return results1;
  })();
